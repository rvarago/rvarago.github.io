...
{% include image.html url="2016-09-05-moving-average-filter_0.png" %}

Our goal is to smooth:

{% include image.html url="2016-09-05-moving-average-filter_1.png" %}
...
{% include image.html url="2016-09-05-moving-average-filter_2.png" %}

Considering the size of our time series as:

{% include image.html url="2016-09-05-moving-average-filter_3.png" %}
...
{% include image.html url="2016-09-05-moving-average-filter_4.png" description="Figure 1: Trend Component." %}
...
{% include image.html url="2016-09-05-moving-average-filter_5.png" %}

Such that:

{% include image.html url="2016-09-05-moving-average-filter_6.png" %}
...
{% include image.html url="2016-09-05-moving-average-filter_7.png" description="Figure 2: Noisy Signal." %}
...
{% include image.html url="2016-09-05-moving-average-filter_8.png" %}
...
{% include image.html url="2016-09-05-moving-average-filter_9.png" %}

That is **one** for frequencies below:

{% include image.html url="2016-09-05-moving-average-filter_10.png" %}

And **zero** elsewhere, _i.e._ :

{% include image.html url="2016-09-05-moving-average-filter_11.png" %}
...
{% include image.html url="2016-09-05-moving-average-filter_12.png" %}

For some defined number of taps:

{% include image.html url="2016-09-05-moving-average-filter_13.png" %}

It's defined by:

{% include image.html url="2016-09-05-moving-average-filter_14.png" %}
...
{% include image.html url="2016-09-05-moving-average-filter_15.png" %}

values, and then divides the summation by:

{% include image.html url="2016-09-05-moving-average-filter_16.png" %}
...
{% include image.html url="2016-09-05-moving-average-filter_17.png" %}
...
{% include image.html url="2016-09-05-moving-average-filter_18.png" %}

And it's shown in Figure 3.

<script src="https://gist.github.com/rvarago/a482c09f9822f7116576b13cf6a0cbbc.js"></script>

{% include image.html url="2016-09-05-moving-average-filter_19.png" description="Figure 3: Filtered Signal." %}
